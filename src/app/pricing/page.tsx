...
const plans = [
  {
    ...
    price: "599",
    leads: "500 Leads",
    features: ["Standard Extraction", "CSV Export", "Email Support", "1 Device Login"],
  ...
  },
  {
    ...
    price: "1,499",
    leads: "5,000 Leads",
    features: ["Advanced Filtering", "Instant WhatsApp Search", "Priority Support", "3 Device Logins", "Verified Badge", "CRM Integration"],
  ...
  },
  {
    ...
    price: "9,999",
    leads: "50,000 Leads",
    features: ["Maximum Velocity", "API Access", "Dedicated Manager", "10 Device Logins", "Custom Reports", "White-label Exports"],
    icon: <Star className="w-6 h-6 text-white text-opacity-90" />,
    bgClass: "bg-slate-900 shadow-slate-900/30",
  },
];
